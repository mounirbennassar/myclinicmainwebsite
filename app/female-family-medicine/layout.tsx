...
export const metadata: Metadata = {
  ...
  description:
    "رعاية متكاملة للمرأة والأسرة في عيادتي — متابعة الحمل والولادة، أمراض النساء، الفحوصات الدورية، رعاية الأم والطفل وطب الأسرة على أيدي نخبة من الطبيبات المتخصصات في جدة والرياض. احجزي موعدكِ 920022811. Comprehensive women's & family healthcare — pregnancy, gynecology, screenings and primary care by our specialists in Jeddah & Riyadh.",
  alternates: { canonical: "/female-family-medicine" },
  openGraph: {
    title: "Women & Family Medicine | طب المرأة والأسرة — عيادتي My Clinic",
    description:
      "رعاية دقيقة ومتكاملة للمرأة والأسرة في كل مرحلة، بخصوصية تامة على أيدي نخبة من الطبيبات المتخصصات. احجزي موعدكِ 920022811.",
