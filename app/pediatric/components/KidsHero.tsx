...
const COPY: { en: HeroCopy; ar: HeroCopy } = {
  en: {
    ...
    titleA: "Complete care",
    titleB: "for your child's health.",
    subtitle:
      "From the very first days through every stage of growth, your child is in expert hands — pediatric care led by some of the Kingdom's top consultants and specialists.",
    ctaPrimary: "Book an appointment today",
    ctaWhatsApp: "WhatsApp us",
    imageAlt: "A happy child smiling with a friendly My Clinic pediatrician",
  },
  ar: {
    eyebrow: "عيادتي للأطفال",
    titleA: "رعاية طبية متكاملة",
    titleB: "لصحة طفلك",
    subtitle:
      "نقدّم في عيادتي رعاية متكاملة للأطفال منذ الأيام الأولى وحتى سنوات النمو، تحت إشراف نخبة من استشاريي وأخصائيي طب الأطفال في المملكة.",
    ctaPrimary: "احجز موعدك اليوم",
