      ...
      <div className="max-w-7xl mx-auto px-4 md:px-8">
        <div className="text-center mb-10 md:mb-14">
          ...
          <h2 className={`mt-4 font-headline text-4xl md:text-[2.9rem] font-extrabold text-slate-900 ${isRtl ? "leading-[1.3]" : "tracking-tight leading-[1.08]"} [text-wrap:balance]`}>
            {isRtl ? "تعرّف على استشاريي طب الأطفال" : "Meet our pediatric specialists"}
          </h2>
          <p className="mt-5 text-slate-600 max-w-2xl mx-auto leading-relaxed">
            {isRtl
              ? "نخبة من استشاريي وأخصائيي طب الأطفال بخبرات دولية، يحبّهم الأطفال ويثق بهم الأهل."
              : "Board-certified pediatric consultants with international training, loved by kids and trusted by parents."}
          </p>
        </div>
